...
export const ResumeCard = ({
  ...
  <div className="flex flex-col gap-4 rounded-20 border border-border bg-card p-5 shadow-sm tablet:flex-row tablet:items-center tablet:gap-6 tablet:p-7">
    ...
    <div className="flex-1">
      <p className="type-body-small text-muted-foreground">Pick up where you left off</p>
    ...
    <Button onClick={onResume} size="lg" className="w-full rounded-full gap-2.5 shadow-md shadow-primary/40 tablet:w-auto">
