...
type KeepsakesPageProps = {
  eventId: string;
};

export const KeepsakesPage = ({ eventId }: KeepsakesPageProps) => {
  return (
    <div className="min-w-0">
      <div>
        ...
        <h1 className="mt-2.5 max-w-[900px] font-serif text-[2rem] font-semibold leading-none tracking-tight tablet:text-[3.375rem]">
          Turn 87 voices into
          <br />
        ...
        <p className="mt-3.5 max-w-[620px] type-body-small leading-relaxed text-muted-foreground">
