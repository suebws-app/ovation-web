...
export const KeepsakesCollection = () => (
  <div className="mt-9">
    <div className="flex flex-col gap-4.5 tablet:flex-row tablet:items-end tablet:justify-between">
      <div>
        <Eyebrow className="text-muted-foreground">More ways to keep it</Eyebrow>
