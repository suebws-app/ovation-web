      ...
      <div className="flex min-h-0 w-full flex-1 flex-col overflow-y-auto">
        <div className="border-border tablet:px-7 flex items-center justify-between gap-3 border-b px-4 py-3">
          <div className="flex items-center gap-2">
            <div className="bg-muted h-8 w-24 rounded-full animate-pulse" />
            <div className="bg-muted h-8 w-20 rounded-full animate-pulse" />
          </div>
          <div className="bg-muted h-8 w-40 rounded-8 animate-pulse" />
        </div>
        ...
        <div className="tablet:p-7 tablet:gap-2 grid grid-cols-3 gap-1 p-2 mobile:grid-cols-4 desktop:grid-cols-6">
          {tiles.map((i) => (
            <div
              key={i}
