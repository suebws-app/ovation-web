    ...
    <SplitLayout
      left={
        <>
          ...
          <p className="type-body-small relative max-w-[360px] leading-relaxed opacity-85">
            Your cover photo sets the tone of every guest screen. You can upload
            anything — an engagement shot, a picture of the venue, a favourite
            place. Or pick a tone for now.
          </p>
        </>
      }
      right={
