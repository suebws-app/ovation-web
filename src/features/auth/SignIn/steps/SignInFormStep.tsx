...
export const SignInFormStep = () => {
  ...
  return (
    <div className="grid min-h-screen desktop:grid-cols-2">
      <div className="flex flex-col items-center px-6 py-12 tablet:px-20">
        <Logo className="self-start" />

        <div className="flex w-full flex-1 flex-col justify-center" style={{ maxWidth: 440 }}>
          <Eyebrow className="mb-2.5 text-primary">Welcome back</Eyebrow>
          <h1 className="font-serif text-[3.25rem] font-semibold leading-[1.05] tracking-tight">
            Sign in to your
            <br />
            <span className="italic text-primary">wedding book.</span>
          </h1>
          <p className="mt-3.5 type-body-small leading-relaxed text-muted-foreground">
          ...
          <div className="mt-3 flex items-center justify-between">
            ...
            />
            <Link href="/forgot-password" className="type-body-small font-semibold text-primary">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="self-start type-caption text-muted-foreground/60">
...
const BrandPanel = () => (
  <div className="relative hidden overflow-hidden bg-gradient-to-br from-primary to-primary/80 p-14 text-primary-foreground desktop:flex desktop:flex-col desktop:justify-between">
    <div
    ...
    <div className="relative">
      <p className="mb-6.5 font-serif text-[2.75rem] italic leading-tight tracking-tight">
    ...
    <p className="relative max-w-[420px] type-body-small leading-relaxed opacity-75">
      87 voices, 1h 42m of stories, 64 photos — held safely for you to revisit whenever you want.
    </p>
  </div>
)
