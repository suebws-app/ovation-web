export const appRoutes = {
  ...
  app: {
    ...
    eventsNewBook: "/app/events/new/book",
    eventsNewCover: "/app/events/new/cover",
    eventsNewUrl: "/app/events/new/url",
    eventsNewDone: "/app/events/new/done",
    event: (id: string) => `/app/events/${id}`,
    eventMessages: (id: string) => `/app/events/${id}/messages`,
